import { imageBaseURL } from '../../../shared/constants/images';
...
const RestaurantCard = ({ restaurant }) => {
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200 max-w-sm">
